...
- [x] 5.1.5 Add test coverage reporting
- [x] 5.1.6 Create `.nycrc` for coverage thresholds
...
- [x] 5.6.2 Test complete user workflows (start → pause → resume → complete, switch modes, auto-start, change settings)
...
- [x] 5.7.1 E2E Tests considered (optional) — not required to count as completed here
