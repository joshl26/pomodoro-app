...
- [x] **2.1.1** Review `settingsSlice.js` (need to see this file)
  - [x] List all actions and reducers
  - [x] Identify which ones actually modify state meaningfully
  - [x] Check for redundant states (e.g., `setCurrentTime` with no params)
  - [x] Look for actions that should be combined
